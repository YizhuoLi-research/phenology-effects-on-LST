...
###### 1. Import data ####
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2019/",pattern=".tif$",full.names = T) )  # Load temperature data (3-363 images)

# Load phenological event data
PHE_q = rast( c("./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Onset_Greenness_Increas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Date_Mid_Greenup_Phase__merged.tif",
                "./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Onset_Greenness_Maximum_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Onset_Greenness_Decreas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Date_Mid_Senescence_Pha_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged/2019/2019-Onset_Greenness_Minimum_merged.tif") )
...
writeRaster(average_diff_21,"./NA_Results/0.diff_result/average_diff_1_2019.tif",overwrite=T)
writeRaster(average_diff_22,"./NA_Results/0.diff_result/average_diff_2_2019.tif",overwrite=T)
writeRaster(average_diff_23,"./NA_Results/0.diff_result/average_diff_3_2019.tif",overwrite=T)
writeRaster(average_diff_24,"./NA_Results/0.diff_result/average_diff_4_2019.tif",overwrite=T)
writeRaster(average_diff_25,"./NA_Results/0.diff_result/average_diff_5_2019.tif",overwrite=T)
writeRaster(average_diff_26,"./NA_Results/0.diff_result/average_diff_6_2019.tif",overwrite=T)
