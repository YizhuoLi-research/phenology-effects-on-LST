...
###### 1. Import data ####
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2014/", pattern=".tif$", full.names = T) )  
# Load Land Surface Temperature (LST) data (3-363 images)

PHE_q = rast( c("./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Onset_Greenness_Increas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Date_Mid_Greenup_Phase__merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Onset_Greenness_Maximum_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Onset_Greenness_Decreas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Date_Mid_Senescence_Pha_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2014/2014-Onset_Greenness_Minimum_merged.tif") )
...
writeRaster(average_diff_21, "./EA_Results/0.diff_result/average_diff_1_2014.tif", overwrite = T)
writeRaster(average_diff_22, "./EA_Results/0.diff_result/average_diff_2_2014.tif", overwrite = T)
writeRaster(average_diff_23, "./EA_Results/0.diff_result/average_diff_3_2014.tif", overwrite = T)
writeRaster(average_diff_24, "./EA_Results/0.diff_result/average_diff_4_2014.tif", overwrite = T)
writeRaster(average_diff_25, "./EA_Results/0.diff_result/average_diff_5_2014.tif", overwrite = T)
writeRaster(average_diff_26, "./EA_Results/0.diff_result/average_diff_6_2014.tif", overwrite = T)
