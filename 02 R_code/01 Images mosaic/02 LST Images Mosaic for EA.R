...
# file_path <- "./01 Download/02 LandSurfaceTemperature_download/EA_LST/_EA_30-35_2013.tif"
# 
# # Open the raster file
# raster_stack <- stack(file_path)
# # Get the number of bands
# band_count <- nlayers(raster_stack)
# print(paste("Number of bands:", band_count))
# # Get and display the band names
# for (i in 1:band_count) {
#   band_name <- names(raster_stack)[i]
#   if (is.null(band_name) || band_name == '') {
#     band_name <- paste("band", i)
#   }
#   print(paste("band", i, "name:", band_name))
# }
