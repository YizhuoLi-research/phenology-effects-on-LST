...
# #计算第一次的RMSE、R
# lst_atc_1 <- na.omit(predict(atc))   # 计算拟合模型的预测值
# lst_raw_1 <- na.omit(df1_LST_noen_Site1$LST)
# RMSE_1=round(sqrt(mean((lst_raw_1 - lst_atc_1)^2)),2)
# R_1=round(cor(lst_atc_1,lst_raw_1),2)
# 
...
#   RMSE_2 = RMSE_2,
#   R_2 = R_2,
#   LST_diff = sum(df1_LST_noen_Site1$LST_diff, na.rm = TRUE) # 累积LST差值
# )
#
# # 打印数据框
# print(output_df)
...
# library(gridExtra)
#
# g1 <- ggplot(df1_LST_noen_Site1, aes(x=DOY)) +
