...
# Set the folder path
setwd("D:/VegetationImpact/01 Download/09 MODIS_Landcover/EA_LandCover")
...
output_folder <- "D:/Graduation_Thesis/01 Download/09 MODIS_Landcover/EA_Results"
output_file <- file.path(output_folder, "EA_LandCover_30km.tif")
...
writeRaster(merged_raster, filename = "D:/Graduation_Thesis/EA_Results/EA_LandCover_30km.tif",
