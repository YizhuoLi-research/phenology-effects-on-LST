...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2018/",pattern=".tif$",full.names = T) )  #3-363张图
...
for (i in 1:7) {
  output_path <- file.path(output_folder, paste0("2018_", names_vector[i], ".tif"))
...
writeRaster(tl2,"./NA_Results/0.atc_evaluation/2018_tl2.tif",overwrite=T)
writeRaster(da2,"./NA_Results/0.atc_evaluation/2018_da2.tif",overwrite=T)
writeRaster(rmse_2,"./NA_Results/0.atc_evaluation/2018_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./NA_Results/0.atc_evaluation/2018_me_2.tif",overwrite=T)
writeRaster(rr_2,"./NA_Results/0.atc_evaluation/2018_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./NA_Results/0.atc_evaluation/2018_pvalue_2.tif",overwrite=T)