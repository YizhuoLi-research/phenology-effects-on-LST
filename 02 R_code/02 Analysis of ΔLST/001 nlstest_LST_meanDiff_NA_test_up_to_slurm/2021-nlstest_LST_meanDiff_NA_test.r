...
###### 1. Import data ####
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2021/",pattern=".tif$",full.names = T) )  # Load temperature data (3-363 images)
...
writeRaster(average_diff_21,"./NA_Results/0.diff_result/average_diff_1_2021.tif",overwrite=T)
writeRaster(average_diff_22,"./NA_Results/0.diff_result/average_diff_2_2021.tif",overwrite=T)
writeRaster(average_diff_23,"./NA_Results/0.diff_result/average_diff_3_2021.tif",overwrite=T)
writeRaster(average_diff_24,"./NA_Results/0.diff_result/average_diff_4_2021.tif",overwrite=T)
writeRaster(average_diff_25,"./NA_Results/0.diff_result/average_diff_5_2021.tif",overwrite=T)
writeRaster(average_diff_26,"./NA_Results/0.diff_result/average_diff_6_2021.tif",overwrite=T)
