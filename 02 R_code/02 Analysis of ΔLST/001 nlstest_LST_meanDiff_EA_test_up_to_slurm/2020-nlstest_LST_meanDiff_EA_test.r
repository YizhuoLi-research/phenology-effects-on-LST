...
###### 1. Import data ####
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2020/", pattern=".tif$", full.names = T) )  
...
writeRaster(average_diff_21, "./EA_Results/0.diff_result/average_diff_1_2020.tif", overwrite = T)
writeRaster(average_diff_22, "./EA_Results/0.diff_result/average_diff_2_2020.tif", overwrite = T)
writeRaster(average_diff_23, "./EA_Results/0.diff_result/average_diff_3_2020.tif", overwrite = T)
writeRaster(average_diff_24, "./EA_Results/0.diff_result/average_diff_4_2020.tif", overwrite = T)
writeRaster(average_diff_25, "./EA_Results/0.diff_result/average_diff_5_2020.tif", overwrite = T)
writeRaster(average_diff_26, "./EA_Results/0.diff_result/average_diff_6_2020.tif", overwrite = T)
