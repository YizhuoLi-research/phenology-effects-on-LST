...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2021/",pattern=".tif$",full.names = T) )  #3-363张图
...
writeRaster(tl2,"./EA_Results/0.atc_evaluation/2021_tl2.tif",overwrite=T)
writeRaster(da2,"./EA_Results/0.atc_evaluation/2021_da2.tif",overwrite=T)
writeRaster(rmse_2,"./EA_Results/0.atc_evaluation/2021_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./EA_Results/0.atc_evaluation/2021_me_2.tif",overwrite=T)
writeRaster(rr_2,"./EA_Results/0.atc_evaluation/2021_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./EA_Results/0.atc_evaluation/2021_pvalue_2.tif",overwrite=T)