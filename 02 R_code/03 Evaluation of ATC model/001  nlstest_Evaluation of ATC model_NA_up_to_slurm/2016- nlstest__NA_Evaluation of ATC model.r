...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2016/",pattern=".tif$",full.names = T) )  #3-363张图
...
for (i in 1:7) {
  output_path <- file.path(output_folder, paste0("2016_", names_vector[i], ".tif"))
...
writeRaster(tl2,"./NA_Results/0.atc_evaluation/2016_tl2.tif",overwrite=T)
writeRaster(da2,"./NA_Results/0.atc_evaluation/2016_da2.tif",overwrite=T)
writeRaster(rmse_2,"./NA_Results/0.atc_evaluation/2016_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./NA_Results/0.atc_evaluation/2016_me_2.tif",overwrite=T)
writeRaster(rr_2,"./NA_Results/0.atc_evaluation/2016_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./NA_Results/0.atc_evaluation/2016_pvalue_2.tif",overwrite=T)