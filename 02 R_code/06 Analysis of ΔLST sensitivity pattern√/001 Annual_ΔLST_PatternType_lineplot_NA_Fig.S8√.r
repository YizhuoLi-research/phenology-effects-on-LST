...
################   01 9年时间序列折线图 ---Northern Hemisphere  #########################
...
df1$average_diff <- as.numeric(as.character(df1$average_diff))    ##########################注意
# df1$group <- "SOS"
...
###  北半球NH  6组：     ##########
################   01 9年SOS时间序列折线图 ---Northern Hemisphere  #########################

##  1  2 3 4 5 6   注意修改                                                     ##注意修改 2处
...
ggsave(filename = "./0.figure/Fig.S8-test-diff&years-NH_6.tiff",     ##注意修改
