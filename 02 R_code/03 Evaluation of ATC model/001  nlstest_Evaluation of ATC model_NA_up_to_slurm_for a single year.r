...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2013/",pattern=".tif$",full.names = T) )  # 3-363 images
...
output_folder <- "./NA_Results/0.atc_evaluation/"  # Path to save the files
...
writeRaster(tl2,"./NA_Results/0.atc_evaluation/2013_tl2.tif",overwrite=T)
writeRaster(da2,"./NA_Results/0.atc_evaluation/2013_da2.tif",overwrite=T)
writeRaster(rmse_2,"./NA_Results/0.atc_evaluation/2013_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./NA_Results/0.atc_evaluation/2013_me_2.tif",overwrite=T)
writeRaster(rr_2,"./NA_Results/0.atc_evaluation/2013_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./NA_Results/0.atc_evaluation/2013_pvalue_2.tif",overwrite=T)