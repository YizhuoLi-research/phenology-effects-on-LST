...
###### 1. Import Data ####
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2020/", pattern=".tif$", full.names = T) )  # 3-363 images
...
##### Export Files ####
writeRaster(sum_diff_12,"./NA_Results/0diff_result/sum_diff_12_2020.tif",overwrite=T)
writeRaster(sum_diff_23,"./NA_Results/0diff_result/sum_diff_23_2020.tif",overwrite=T)
writeRaster(sum_diff_34,"./NA_Results/0diff_result/sum_diff_34_2020.tif",overwrite=T)
writeRaster(sum_diff_45,"./NA_Results/0diff_result/sum_diff_45_2020.tif",overwrite=T)
writeRaster(sum_diff_56,"./NA_Results/0diff_result/sum_diff_56_2020.tif",overwrite=T)
writeRaster(sum_diff_16,"./NA_Results/0diff_result/sum_diff_16_2020.tif",overwrite=T)
