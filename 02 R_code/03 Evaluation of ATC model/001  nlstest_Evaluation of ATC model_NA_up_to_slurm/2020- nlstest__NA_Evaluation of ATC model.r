...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/NA_LST/2020/",pattern=".tif$",full.names = T) )  #3-363张图
...
writeRaster(tl2,"./NA_Results/0.atc_evaluation/2020_tl2.tif",overwrite=T)
writeRaster(da2,"./NA_Results/0.atc_evaluation/2020_da2.tif",overwrite=T)
writeRaster(rmse_2,"./NA_Results/0.atc_evaluation/2020_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./NA_Results/0.atc_evaluation/2020_me_2.tif",overwrite=T)
writeRaster(rr_2,"./NA_Results/0.atc_evaluation/2020_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./NA_Results/0.atc_evaluation/2020_pvalue_2.tif",overwrite=T)