...
input_dir  <- "./EA_Results/0.sum_diff/"
output_dir <- "./EA_Results/0.sum_diff/0common_pixel/"
...
for (year in years) {
  ...
  aa <- rast(paste0("./EA_Results/0diff_result/0common_pixel/average_diff_1_", year, ".tif"))  
  sample_diff <- aa
