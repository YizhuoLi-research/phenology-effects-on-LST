...
# Set the folder path
setwd("D:/VegetationImpact/01 Download/04 Koppen-Geiger climate map_download/EA_koppen")
...
output_folder <- "D:/VegetationImpact/01 Downdload/04 Koppen-Geiger climate map_download/EA_Results"
output_file <- file.path(output_folder, "EA_koppen_30km.tif")
