...
setwd("D:/VegetationImpact/01 Download/03 PhenologicalEvents_download/NA_PHE")
...
for (key in names(file_groups)) {
  ...
  output_folder <- "D:/VegetationImpact/01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged"
...
setwd("D:/VegetationImpact/01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged")
...
for (file in merged_tif_files) {
  ...
  year_folder <- file.path("D:/VegetationImpact/01 Download/03 PhenologicalEvents_download/NA_PHE/NA_PHE_merged", year)
