...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2019/",pattern=".tif$",full.names = T) )  #3-363张图

PHE_q = rast( c("./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Onset_Greenness_Increas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Date_Mid_Greenup_Phase__merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Onset_Greenness_Maximum_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Onset_Greenness_Decreas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Date_Mid_Senescence_Pha_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2019/2019-Onset_Greenness_Minimum_merged.tif") )
PHE_q[PHE_q>365] = NA
...
####保存pr_test结果
output_folder <- "./EA_Results/0.atc_evaluation/"  # 保存文件的文件夹路径
if (!dir.exists(output_folder)) {
  dir.create(output_folder, recursive = TRUE)
}
names_vector <- c("tl","da","st","rmse","me","rr","pvalue")
for (i in 1:7) {
  output_path <- file.path(output_folder, paste0("2019_", names_vector[i], ".tif"))
...
writeRaster(tl2,"./EA_Results/0.atc_evaluation/2019_tl2.tif",overwrite=T)
writeRaster(da2,"./EA_Results/0.atc_evaluation/2019_da2.tif",overwrite=T)
writeRaster(rmse_2,"./EA_Results/0.atc_evaluation/2019_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./EA_Results/0.atc_evaluation/2019_me_2.tif",overwrite=T)
writeRaster(rr_2,"./EA_Results/0.atc_evaluation/2019_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./EA_Results/0.atc_evaluation/2019_pvalue_2.tif",overwrite=T)