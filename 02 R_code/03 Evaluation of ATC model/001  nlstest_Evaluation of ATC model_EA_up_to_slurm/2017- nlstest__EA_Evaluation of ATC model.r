...
LST = rast( list.files("./01 Download/02 LandSurfaceTemperature_download/EA_LST/2017/",pattern=".tif$",full.names = T) )  #3-363张图

PHE_q = rast( c("./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Onset_Greenness_Increas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Date_Mid_Greenup_Phase__merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Onset_Greenness_Maximum_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Onset_Greenness_Decreas_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Date_Mid_Senescence_Pha_merged.tif",
                "./01 Download/03 PhenologicalEvents_download/EA_PHE/EA_PHE_merged/2017/2017-Onset_Greenness_Minimum_merged.tif") )
PHE_q[PHE_q>365] = NA
...
for (i in 1:7) {
  output_path <- file.path(output_folder, paste0("2017_", names_vector[i], ".tif"))
...
writeRaster(tl2,"./EA_Results/0.atc_evaluation/2017_tl2.tif",overwrite=T)
writeRaster(da2,"./EA_Results/0.atc_evaluation/2017_da2.tif",overwrite=T)
writeRaster(rmse_2,"./EA_Results/0.atc_evaluation/2017_rmse_2.tif",overwrite=T)
writeRaster(me_2,"./EA_Results/0.atc_evaluation/2017_me_2.tif",overwrite=T)
writeRaster(rr_2,"./EA_Results/0.atc_evaluation/2017_rr_2.tif",overwrite=T)
writeRaster(pvalue_2,"./EA_Results/0.atc_evaluation/2017_pvalue_2.tif",overwrite=T)